...
| WORKFLOW-001 | Workflow submissions hard-lock Wan 2.2 high/low diffusion model filenames at runtime. | Web uploads, Telegram workflows, default workflows, and prompt build fallback must normalize old fp8 UNETLoader names before archive/submission. |

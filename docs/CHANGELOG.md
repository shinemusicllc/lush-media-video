...
- Production recovery: retention removed 6,782 terminal jobs and about 44.93 GB of expired assets, removed seven obsolete May archives (18.65 GB), and created a verified current archive. Docker build-cache cleanup then removed 11.13 GB; disk use fell from 99% (1.8 GB free) to 27% (71 GB free) without restarting app containers or Meta Ads services.

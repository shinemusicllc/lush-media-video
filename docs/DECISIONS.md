...
| Use temporally tiled VAE and 61 frames for bundled video workflows | Regular VAE decode exhausted VRAM on 73-frame Wan output; tiled decode completed the same graph, while reducing the bundled frame count increases operating margin. | Workflow reliability | 2026-07-30 |
...
| Khóa mọi workflow được app chấp nhận ở 61 frame | Workflow 6s cũ do người dùng tải lên vẫn có thể làm cạn RAM; web, Telegram và prompt cuối phải cùng chuẩn hóa thời lượng trước khi archive và submit. | Workflow reliability | 2026-07-30 |
